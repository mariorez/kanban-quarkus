MERGE INTO board_column(id, external_id, position, name, created_at, updated_at) values
...
MERGE INTO card(id, board_column_id, external_id, position, name, created_at, updated_at) values
